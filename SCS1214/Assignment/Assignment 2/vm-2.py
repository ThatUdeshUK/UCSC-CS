...
# Added missing ret function 
# Return back to the last process in the stack
def ret(opr):
	reg['pc'] = memory[reg['sp']]; # Set pc to the postion stored in stack
	reg['sp'] = reg['sp'] - 1; # Decrement stack pointer
